...
class SIM800:
    ...
    """
    def __init__(self, uart_device_rx_pin, uart_device_tx_pin, baud=115200):
        """
        Initializes the UART connection with the SIM800 module.
        """
        # self.uart = machine.UART(uart_pin, baudrate=baud)
        self.uart = machine.UART(1, baudrate=115200, tx=machine.Pin(uart_device_rx_pin), rx=machine.Pin(uart_device_tx_pin))
        self.initialize()
